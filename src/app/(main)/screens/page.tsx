...
export const metadata: Metadata = pageMetadata({
  title: "スクリーン — 高配当・低 PER・割安銘柄を切り口別に",
  description:
...
export default async function ScreensHub() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-12">
          ...
          return (
            ...
            >
              <div className="flex items-baseline justify-between mb-3">
                ...
                <span className="text-[10px] text-foreground/60 tabular">{count} 社</span>
              </div>
      ...
      <section className="mt-16 pt-8 border-t border-border text-[12px] text-foreground/60 leading-relaxed">
