            ...
            return (
              ...
              >
                <div className="flex items-baseline justify-between mb-3">
                  ...
                  <span className="text-[10px] text-foreground/60">{agg.count} 社</span>
                </div>
                ...
                <div className="flex flex-wrap gap-1 mb-4">
                  ...
                  {ind.subClusters.length > 4 && (
                    <span className="text-[10px] text-foreground/60">+{ind.subClusters.length - 4}</span>
                  )}
                </div>
                <div className="text-[11px] text-muted-foreground tabular border-t border-border pt-3">
        ...
        <section>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-3">
            {COMING_SOON.map((cs) => (
              ...
              >
                <div className="text-[10px] text-foreground/60 tracking-wider mb-1">準備中</div>
                <h3 className="font-bold">{cs.name}</h3>
                <p className="text-[11px] text-muted-foreground mt-1 leading-relaxed">{cs.note}</p>
              </div>
            ))}
          </div>
        </section>
