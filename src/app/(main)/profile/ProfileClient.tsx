          ...
          {myUpcoming.length > 0 && (
            <section className="mb-12">
              <div className="flex items-end justify-between mb-4 pb-2 border-b border-border">
                ...
                <span className="text-[11px] text-foreground/60">{myUpcoming.length} 件</span>
              </div>
          ...
          {myResolved.length > 0 && (
            <section className="mb-12">
              <div className="flex items-end justify-between mb-4 pb-2 border-b border-border">
                ...
                <span className="text-[11px] text-foreground/60">{myResolved.length} 件</span>
              </div>
              <div className="grid sm:grid-cols-2 gap-3">
                {myResolved.map((v) => (
                  <PredictionListItemWithVote
    ...
    >
      <div
        className={`text-[10px] tracking-wider mb-1 ${
          accent ? "text-background/70" : "text-foreground/60"
        }`}
      >
        {label}
      </div>
      ...
      {sub && (
        <div
          className={`text-[10px] mt-1.5 ${accent ? "text-background/60" : "text-foreground/60"}`}
        >
          {sub}
        </div>
      )}
...
function EmptyState() {
  return (
    <div className="border border-border rounded-md bg-surface-elev px-6 py-10 text-center">
      ...
      <p className="text-[13px] text-muted-foreground leading-relaxed max-w-md mx-auto mb-6">
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute top-3 right-3 pointer-events-none">
        ...
        >
          <span className="text-foreground/60">あなた:</span>
