    ...
    <section className="mb-12">
      ...
      <div className="grid sm:grid-cols-3 gap-4">
        <div className="bg-surface border border-border rounded-md p-5">
          <div className="text-foreground text-xs font-bold tracking-widest mb-3">① 似た会社が見つかる</div>
        ...
        <div className="bg-surface border border-border rounded-md p-5">
          <div className="text-foreground text-xs font-bold tracking-widest mb-3">② 会社の今がわかる</div>
          <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <div className="bg-surface border border-border rounded-md p-5">
          <div className="text-foreground text-xs font-bold tracking-widest mb-3">③ リスクの種類がわかる</div>
          <p className="text-sm text-muted-foreground leading-relaxed">
