  ...
  return (
    <section className="mb-16 pt-12 border-t border-border">
      <div className="flex items-end justify-between mb-3">
        ...
        <Link href="/industries" className="text-sm text-muted-foreground hover:text-foreground transition">
          業界一覧へ →
        </Link>
      </div>
        ...
        {coverage.map(({ industry, agg }) => (
          ...
          >
            <div className="flex items-baseline justify-between mb-2">
              ...
              <div className="text-[10px] text-foreground/60 tabular">{agg.count} 社</div>
            </div>
            <div className="text-[10px] mb-2">
              <div className="text-foreground/60">平均 PER</div>
            ...
            <div className="mt-2 pt-2 border-t border-border text-[10px] text-foreground/60 group-hover:text-foreground transition flex items-center justify-end gap-1">
