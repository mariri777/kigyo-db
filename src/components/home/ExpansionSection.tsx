  ...
  return (
    <section className="mb-16">
      <div className="flex items-end justify-between mb-3">
        ...
        <Link href="/screens/expansion-phase" className="text-sm text-muted-foreground hover:text-foreground transition">
          拡大期銘柄一覧へ →
        </Link>
      </div>
      ...
      <details className="mb-5 group">
        <summary className="text-[11px] text-foreground/60 hover:text-muted-foreground cursor-pointer inline-flex items-center gap-1 select-none">
          <span className="group-open:rotate-90 transition-transform inline-block">▸</span>
          指標の見方
        </summary>
        <div className="text-[11px] text-foreground/60 leading-relaxed mt-2 pl-4 border-l border-border max-w-2xl space-y-1">
          <div><strong className="text-muted-foreground font-bold">売上成長</strong> 過去3年の年平均成長率</div>
          <div><strong className="text-muted-foreground font-bold">営業利益率</strong> 本業利益÷売上（15%超で優良）</div>
          <div><strong className="text-muted-foreground font-bold">PER</strong> 株価÷1株利益</div>
        </div>
      </details>
